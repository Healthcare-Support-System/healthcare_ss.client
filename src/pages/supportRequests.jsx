    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{ borderBottom: "1px solid #ede6f7" }}
        >
          <div className="max-w-4xl mx-auto">
            ...
            <p
              className="text-[13.5px] max-w-lg leading-relaxed"
              style={{ color: "#9b6db5" }}
            >
            ...
            {activeSupportRequests.length > 0 && (
              ...
              >
                ...
                >
                  ...
                  {activeSupportRequests.length !== 1 ? "s" : ""}
                </span>
              </div>
            )}
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-2.5 min-w-0">
                        <div
                          ...
                          style={{
                            background: isUnavailable ? "#8a7db8" : "#4a2999",
                          }}
                        >
                          <svg
                            width="14"
                        ...
                        <h2
                          ...
                          style={{
                            color: isUnavailable ? "#5a4f82" : "#3d2a7a",
                          }}
                        >
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        <span
                          className={`inline-flex items-center gap-1.5 text-[11px] font-semibold px-2.5 py-1 rounded-full ${uc.pill}`}
                        >
                          <span
                        ...
                        <span
                          className={`text-[11px] font-semibold px-2.5 py-1 rounded-full ${sc.pill}`}
                        >
                          {sc.label}
                        </span>
                      </div>
                    ...
                    <div className="px-5 py-4">
                      ...
                      {request.description && (
                        <p
                          className="text-[13px] leading-relaxed mb-4 pl-3"
                          style={{
                            color: "#3d2255",
                            borderLeft: "3px solid #e2789b",
                          }}
                        >
                          {request.description}
                        </p>
                      ...
                      {hasItems && (
                        <div className="mb-4">
                          <span
                            className="text-[9.5px] font-bold uppercase tracking-[0.12em] block mb-2"
                            style={{ color: "#9b6db5" }}
                          >
                            Requested Items
                          </span>
                            ...
                            {request.items.map((item, index) => (
                              ...
                              >
                                ...
                                <div className="flex items-center gap-3">
                                  ...
                                  <span
                                    className="text-[11.5px] font-semibold rounded-lg px-2 py-0.5"
                                    style={{
                                      color: "#4a2999",
                                      background: "#eee8ff",
                                    }}
                      ...
                      <div className="flex items-center justify-between pt-1">
                        ...
                        <button
                          type="button"
                          onClick={() =>
                            !isUnavailable && handleDonateClick(request.id)
                          }
